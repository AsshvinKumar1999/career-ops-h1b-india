...
When the user pastes a JD (text or URL) without an explicit subcommand, execute the ENTIRE pipeline in sequence:
...
1. **Extract form questions**: Use Playwright to navigate to the form and snapshot. If questions can't be extracted, use generic questions.
